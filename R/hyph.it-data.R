...
#' 
#' Hyphenation patterns for Italian to be used by \code{\link[sylly:hyphen]{hyphen}}.
...
#' \dontrun{
#' library(sylly.it)
#' sampleText <- c("questo","e","un","esempio","piuttosto","stupido")
#' hyphen(sampleText, hyph.pattern="it")
#' }
NULL
